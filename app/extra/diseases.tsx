    ...
    <>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.hello}>Crop Disease Detection</Text>
        </View>

        <ScrollView contentContainerStyle={styles.scrollContent}>
          <Text style={styles.sectionTitle}>How Detection Works</Text>
          <Text style={styles.text}>
            Upload or capture an image of a crop leaf. The system analyzes
            patterns like spots, discoloration, and texture using AI to predict
            possible diseases and suggest treatment.
          </Text>
          ...
          <Text style={styles.sectionTitlee}>Detect Disease</Text>
          ...
          <View style={styles.tipCard}>
            <Text style={styles.tip}>• Use certified seeds</Text>
            <Text style={styles.tip}>• Practice crop rotation</Text>
            <Text style={styles.tip}>• Avoid overcrowding</Text>
            <Text style={styles.tip}>• Ensure drainage</Text>
            <Text style={styles.tip}>• Monitor crops regularly</Text>
          </View>

          <Text style={styles.sectionMore}>
            You can also view Crop Pests Analysis
          </Text>

          <View style={styles.commodityCard}>
            <Text style={styles.sectionTitlee}>Crop Pests Analysis</Text>
